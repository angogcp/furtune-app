-- Fortune App Database Setup Script
...
/*
INSERT INTO public.wishes (content, is_anonymous) VALUES
('希望今年能找到真爱', true),
('愿家人身体健康', true),
('希望事业蒸蒸日上', false);
*/
...
-- Success message
SELECT 'Database setup completed successfully! You can now use authentication features.' as message;
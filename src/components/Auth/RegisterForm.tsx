  ...
  return (
    <div className="bg-purple-900/50 rounded-lg p-8 border border-purple-400/30 max-w-md mx-auto">
      <div className="text-center mb-6">
        ...
        <p className="text-purple-200">{t('auth.registerSubtitle')}</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-purple-200 mb-2">{t('auth.username')}</label>
        ...
        <div>
          <label className="block text-sm font-medium text-purple-200 mb-2">{t('auth.confirmPassword')}</label>
          <div className="relative">
            <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-purple-400" />
            <input
